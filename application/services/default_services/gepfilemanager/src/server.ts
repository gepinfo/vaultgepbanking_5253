...
class App {
    ...
    private DatabaseCredentials() {
        ...
        SCMconfig.SCMData( async result => {
            this.DB_Url = result.data.DB_URL_vaultgepbanking_5253;
            let db_auth = result.data.DB_AUTH_vaultgepbanking_5253;
            let db_coll = result.data.DB_COLL_vaultgepbanking_5253;
